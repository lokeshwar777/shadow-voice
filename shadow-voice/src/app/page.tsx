...
export default function LandingPage() {
    return (
        <div className="flex flex-col relative min-h-screen bg-gray-950 text-white">
            <div className="flex flex-col items-center justify-center flex-grow">
                <h1 className="text-4xl font-extrabold mb-3">Shadow Voice</h1>
                <p className="text-gray-400 mb-6 text-center max-w-md">
                    Connect anonymously. Speak freely. Stay secure.
                </p>
            ...
            <footer className="w-full py-1 bg-gray-900 text-gray-400 text-center bg-opacity-60">
                <div className="flex flex-wrap justify-center gap-4">
                    <Link href="footer/about/" className="hover:text-white transition">About</Link>s
